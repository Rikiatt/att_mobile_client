...
import { swalToast, swalQuestionConfirm, swalInputText, swalInfoChooseText } from './utils/swal';
...
function SetupConnect({ setMutate, seting }) {
  ...
  return (
    <Stack direction="row" alignItems="center" spacing={2}>
      <FormControlLabel sx={{ background: seting.connect == 'org' ? '#a9ffa9' : 'unset', p: "0 8px", borderRadius: 12 }} control={
        !seting.org

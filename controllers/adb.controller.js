const { listDevice, startADB, delADBImg, clickConfirmVTB, inputPINVPB, inputPINMSB, inputPINBIDV, inputPINVTB, 
  ...
  clickConfirmScanFaceBIDV, clickScanQRVPB, clickScanQRNAB, clickScanQRMSB, clickScanQRMB, clickScanQRNCB, clickLoginNAB, clickLoginBAB, clickScanQRBAB, clickScanQROCB, clickSelectImageNAB, clickSelectImageTPB, clickSelectImageVPB, clickSelectImageNCB, clickSelectImageMSB, clickSelectImageMB, clickSelectImageOCB, clickScanQRBIDV, clickSelectImageBIDV, clickConfirmMB, clickConfirmOCB, clickConfirmBIDV, 
  startAppADBACB, stopAppADBACB, stopAppADBBAB, stopAppADBOCB, startAppADBBAB, startAppADBOCB, stopAppADBBIDV, startAppADBBIDV, stopAppADBTPB, stopAppADBVPB, stopAppADBNAB, startAppADBTPB, startAppADBVPB, startAppADBNAB, stopAppADBNCB, startAppADBNCB, startAppADBMSB, stopAppADBMSB, stopAppADBMB, startAppADBMB, stopAppADBVCB, startAppADBVCB, stopAppADBVTB, startAppADBVTB, stopAppADBSHB, startAppADBSHB, 

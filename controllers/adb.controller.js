const { listDevice, startADB, delADBImg, clickConfirmVTB, inputPINVPB, inputPINMSB, inputPINBIDV, inputPINVTB, 
  ...
  clickLoginACB, clickSelectImageACB, clickSelectImageEXIM, trackACB, trackEXIM, trackOCB, trackNAB, trackTPB, trackVPB, trackMSB, trackMB } = require('../functions/adb.function');
...
const mapAction = {
  ...
  clickSelectImageEXIM: clickSelectImageEXIM,
  trackOCB: trackOCB,
  trackACB: trackACB,
  trackEXIM: trackEXIM,
  trackNAB: trackNAB,

const { listDevice, startADB, delADBImg, clickConfirmVTB, inputPINVPB, inputPINMSB, inputPINBIDV, inputPINVTB, 
  ...
  stopAllApps, clickLoginACB, scanQRACB, scanQREXIM, clickPasswordFieldEXIM, trackACB, trackEXIM, trackOCB, trackNAB, trackTPB, trackVPB, trackMSB, trackMB, trackSHBSAHA } = require('../functions/adb.function');
...
const mapAction = {
  ...
  clickPasswordFieldEXIM: clickPasswordFieldEXIM,
  trackACB: trackACB,
  trackEXIM: trackEXIM,
  trackOCB: trackOCB,  
  trackNAB: trackNAB,
